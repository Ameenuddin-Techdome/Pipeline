...
const PromotionalGallery = ({
  ...
  return (
    <section
      className="w-full flex flex-col relative py-16 px-4 sm:px-10 lg:px-20 overflow-hidden"
        ...
        <div className="text-center mb-10 sm:mb-14 lg:mb-16">
          ...
          <button
            className="mt-6 sm:mt-8 px-6 sm:px-8 py-3 text-white text-base sm:text-lg 
                   font-medium rounded-md shadow-lg hover:brightness-110 transition-all"
