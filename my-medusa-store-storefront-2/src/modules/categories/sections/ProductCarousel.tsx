                    ...
                    <div className="flex flex-col pb-1">
                        ...
                        <div className="flex gap-2 w-full mt-1">
                            <LocalizedClientLink
                                ...
                                className="flex-1"
                            >
                                <button className="w-full flex items-center justify-center gap-1 py-1.5 text-xs font-medium rounded-lg border hover:bg-indigo-50" 
                                style={{
                                    borderColor: color,
                                    color: color,
                            ...
                            <LocalizedClientLink
                                ...
                                className="flex-1"
                            >
                                <button className="w-full flex items-center justify-center gap-1 py-1.5 text-xs font-medium rounded-lg text-white"
                                style={{
